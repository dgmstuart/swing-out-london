...
RSpec.describe EventsImporter do
  describe "import" do
    it "takes a CSV and returns the names of the relevant events" do
      ...
      allow(resource_klass).to receive(:find_by_url).with("www.wibble.com/silentbleep").and_return(silentbleep)
      beefheart= instance_double("Event", id: 2, title: "Beefheart", url: "www.frank.com/beefheart")
      allow(resource_klass).to receive(:find_by_url).with("www.frank.com/beefheart").and_return(beefheart)
