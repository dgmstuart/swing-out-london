...
if RSpec.configuration.files_to_run.one?
      ...
      module RailsShim
        class << self
          def serialized_attributes_for(model)
            # the real definition depends on ::ActiveRecord::Type::Serialized,
            # which we're not loading in these isolated specs:
  ...
  # Add locale to the path for Faker, unless it's already been set up and frozen by a previous spec
