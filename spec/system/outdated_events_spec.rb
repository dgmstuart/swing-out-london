...
RSpec.describe 'Outdated events' do
  ...
  it 'when there are outdated and nearly outdated events' do
    outdated_event = FactoryBot.create(:event, title: 'Corner', id: 1, frequency: 4, dates: [Date.local_today - 4.weeks])
    nearly_outdated_event = FactoryBot.create(:event, title: 'Jam', id: 2, frequency: 4, dates: [Date.local_today + 1.week])
