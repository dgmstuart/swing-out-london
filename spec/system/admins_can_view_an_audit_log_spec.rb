...
RSpec.describe "Admins can view an audit log" do
  ...
  it "showing a list of audited events" do
    ...
    expect(page).to have_text("Missing name create Event")
    expect(page).to have_text("Missing name create Venue")
    expect(page).to have_text("Missing name create Organiser")
  ...
  context "when logged in as a non-admin" do
    it "does not allow access" do
      ...
      expect(page).to have_no_text("Audit Log")
